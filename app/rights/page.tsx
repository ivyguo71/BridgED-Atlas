...
const sections = [
  { title: 'rights.s1.title' as const, body: 'rights.s1.body' as const, icon: '⚖️' },
  { title: 'rights.s2.title' as const, body: 'rights.s2.body' as const, icon: '🤝' },
  { title: 'rights.s3.title' as const, body: 'rights.s3.body' as const, icon: '⏰' },
  { title: 'rights.s4.title' as const, body: 'rights.s4.body' as const, icon: '💴' },
  { title: 'rights.s5.title' as const, body: 'rights.s5.body' as const, icon: '🏖️' },
  { title: 'rights.s6.title' as const, body: 'rights.s6.body' as const, icon: '🛡️' },
];
...
export default function RightsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="mb-12">
        <Checklist
          title={t('rights.checklist.title')}
          items={[
            t('rights.checklist.1'),
            t('rights.checklist.2'),
            t('rights.checklist.3'),
            t('rights.checklist.4'),
          ]}
        />
      </div>
